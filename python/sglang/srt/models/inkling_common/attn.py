...
class InklingAttention(nn.Module):
    ...
    def _fa4_rel_proj(self, dtype: torch.dtype) -> torch.Tensor:
        ...
        The learned proj is shared across heads; expand once and cache. The
        kernel requires rel_proj to match rel_r's dtype.
        """
    ...
    def forward(
        ...
        *,
        ...
        fused_rel = (
            fa4
            and envs.SGLANG_OPT_USE_INKLING_FUSED_REL_PROJ.get()
