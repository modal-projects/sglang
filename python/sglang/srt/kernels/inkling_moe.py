...
from sglang.srt.kernels.helion_utils import get_model_depths, helion_aot_autotune
...
def fused_moe_preprocess(topk_ids_flat: torch.Tensor, num_experts: int):
    ...
    expert_block_schedule = torch.empty(max_num_blocks, device=device, dtype=torch.int32)
