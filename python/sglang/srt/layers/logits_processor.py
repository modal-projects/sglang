...
# Aux hidden states arrive either as a list of per-layer [tokens, hidden]
# tensors or pre-packed as one [tokens, K * hidden] tensor (models that pack
# during the layer loop to avoid a second full-size concat allocation).
