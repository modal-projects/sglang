...
def plan_out_scales(
    ...
    Returns:
        A list of (t, h, w, c) tuples representing the dimensions after each layer.
        The length of the list equals n_layers + 1, including the input dimensions.

    Raises:
        ValueError: If patch_size <= 1, which would not make sense for this architecture
    """
    if patch_size <= 1:
        raise ValueError(
