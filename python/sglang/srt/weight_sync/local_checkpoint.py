...
# Base-seed copy tuning. The /prep read is Volume-backend-fetch bound: a few parallel streams
# recover ~5x over one (profiled), but past ~8 the mount over-subscribes and regresses. 16 MiB
# chunks read at full mount speed (small reads crawl) while bounding the parallel copy's memory.
