        ...
        try:
            with torch.cuda.device(self.gpu_id):
                stager = RankWeightStager(
                    ...
                    # Native post-load transforms may launch CUDA work. Use the
                    # model stream so staging and inference have one device
                    # order instead of forming cross-stream allocator waits.
