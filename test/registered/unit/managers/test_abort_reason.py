...
class TestAbortReason(CustomTestCase):
    def test_scheduler_preserves_waiting_and_running_abort_reason(self):
        ...
        waiting = MagicMock(rid="waiting")
        waiting.kv.holds_mamba = False
        ...
        with patch(
            ...
            side_effect=lambda req, finished_reason=None: AbortReq(
                rid=req.rid, finished_reason=finished_reason
            ),
        ):
