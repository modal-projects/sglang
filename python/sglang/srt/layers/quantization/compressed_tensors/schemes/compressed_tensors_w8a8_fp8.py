...
class CompressedTensorsW8A8Fp8(CompressedTensorsLinearScheme):
    ...
    def restore_weights_before_loading(self, layer) -> None:
        ...
        if self.strategy == QuantizationStrategy.BLOCK:
            restore_ue8m0_scale_checkpoint_layout(getattr(layer, "weight_scale", None))
    ...
    def process_weights_after_loading(self, layer) -> None:
        if self.strategy == QuantizationStrategy.BLOCK:
            record_ue8m0_scale_checkpoint_layout(getattr(layer, "weight_scale", None))
        if self.strategy == QuantizationStrategy.TENSOR:
            ...
            if is_fp8_fnuz() or _use_aiter:
                ...
                # so in-place reloads can refill them; the kernel takes
