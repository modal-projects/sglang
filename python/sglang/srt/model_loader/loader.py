...
def _get_quantization_config(
    ...
    if model_config.quantization is not None:
        ...
        # A config-aware classmethod takes precedence over the static class
        # attribute (needed when the rename depends on the checkpoint, e.g.
        # NextN drafts whose layer index is num_hidden_layers).
