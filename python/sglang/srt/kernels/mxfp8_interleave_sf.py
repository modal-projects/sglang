...
def store_sf_interleaved(
    ...
    assert page_size == 128, f"Interleaved SF layout requires page_size=128, got {page_size}"
    ...
    sf_out_u8 = sf_out.view(torch.uint8) if sf_out.dtype == torch.float8_e8m0fnu else sf_out
