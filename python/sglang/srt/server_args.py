...
class ServerArgs:
    ...
    speculative_draft_kv_cache_dtype: A[
        Optional[str],
        "KV cache dtype for the DRAFT worker's (separate) KV pool, independent "
        "of --kv-cache-dtype. Same choices (e.g. fp8_e4m3). Default: inherit "
        "the global --kv-cache-dtype.",
    ] = None
