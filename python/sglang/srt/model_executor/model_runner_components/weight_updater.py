    ...
    def update_weights_from_disk(
        ...
        load_config = LoadConfig(
            ...
            model_loader_extra_config=(
                self.get_model_runner().server_args.model_loader_extra_config
            ),
        )
        ...
        def get_weight_iter(config, *, apply_filter: bool):
        ...
        def rollback():
            ...
            model_load_weights(self.get_model(), original_iter)
        ...
        with set_default_torch_dtype(self.model_config.dtype):
            try:
                ...
                iter = get_weight_iter(self.model_config, apply_filter=True)
