...
class PullTest(unittest.TestCase):
    ...
    def test_incremental_pulls_are_idempotent(self):
        ...
        self.assertEqual(stats["apply"]["changed_tensors"], 1)
        ...
        stats = self.pull(1)  # no-op
        self.assertEqual(stats["operation"], "noop")
        self.assert_at_version(1)
        self.pull(2)
        self.assert_at_version(2)

    def test_pull_can_rollback_to_an_older_version(self):
        self.pull(2)
        stats = self.pull(1)
        self.assert_at_version(1)
    ...
    def test_multi_delta_pull_handles_repeated_tensor_changes(self):
    ...
    def test_multi_delta_pull_reseeds_corrupt_local_checkpoint(self):
