...
class Envs:
    ...
    # Log-only diagnostic: measure (never correct) whether DFLASH commits
    # different accept_len/bonus on different TP ranks. Default OFF = zero
    # overhead, no collective at all.
    SGLANG_DFLASH_TP_DETECT = EnvBool(False)
