...
class Envs:
    ...
    SGLANG_ENABLE_MEGAMOE_KERNEL_TIMING = EnvBool(False)
    SGLANG_MEGAMOE_KERNEL_TIMING_PATH = EnvStr("/tmp/megamoe_kernel_timing.jsonl")
    SGLANG_MEGAMOE_KERNEL_TIMING_FIELDS = EnvInt(32)
