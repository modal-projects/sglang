...
def flash_attn_varlen_func(
    ...
    q_descale: Optional[torch.Tensor] = None,  # legacy per-tensor FP8 descale scalar (fp8_e4m3/e5m2 KV)
    ...
    sfq: Optional[torch.Tensor] = None,  # MXFP8 UE8M0 per-32-elem block scales (block-scaled QK^T)
