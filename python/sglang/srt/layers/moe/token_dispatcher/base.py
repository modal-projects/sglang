...
class BaseDispatcher(ABC):
    ...
    def clone_for_weight_update(self) -> BaseDispatcher:
        ...
        def clone_value(value):
            clone_for_update = getattr(value, "clone_for_weight_update", None)
            if callable(clone_for_update):
                return clone_for_update()
        ...
        # wrappers. A weight-update clone must neither retain those live bindings
