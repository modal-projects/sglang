...
def inkling_ar_scattered_sconv(
    ...
    *,
    ...
    if do_norm:
        assert out_local is not None and norm_residual is not None and norm_out is not None
    else:
...
def inkling_ar_col_decode(
    ...
    *,
    ...
    module.ar_col_decode(
        in_buffer, out_local, residual_in, residual_out, hs_out,
        norm_weight, norm_eps, sconv_cache, cache_indices, cache_mask,
        weight_shard, track_mask, track_dst,
        mc_in, mc_out, flag_ptrs_dev, state_ptr, rank, vecs_per_thread,
    )
...
def inkling_ar_banded_sconv(
    ...
    *,
    ...
    module.ar_banded_sconv(
        in_buffer, scratch, sconv_cache, safe_idx, cache_mask, cache_indices,
        has_initial_state, cu, si, weight, track_rows, track_mask, track_dst,
        mc_in, mc_out, flag_ptrs_dev, state_ptr, rank,
        num_blocks, block_size, per_block_barrier, debug_phase,
        mc_wstage, local_wstage,
    )
