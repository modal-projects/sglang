...
Commit waits for active requests, blocks admission of new requests, flushes the KV
cache, and updates the externally visible version only after every rank succeeds.
