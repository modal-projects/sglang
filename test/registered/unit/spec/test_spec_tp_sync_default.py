...
def test_default_includes_dflash_greedy_sites(monkeypatch):
    ...
    assert SpecTpSyncSite.DFLASH_DRAFT_SAMPLE in sites
    assert int(SpecTpSyncSite.DFLASH_DRAFT_SAMPLE) == 17
    assert SpecTpSyncSite.DFLASH_DRAFT_SAMPLE.slug == "dflash-draft-sample"
...
def test_rng_preset_includes_sampled_proposal():
    assert SpecTpSyncSite.DFLASH_DRAFT_SAMPLE in parse_spec_tp_sync("rng")
    assert SpecTpSyncSite.DFLASH_DRAFT_GREEDY not in parse_spec_tp_sync("rng")
    assert SpecTpSyncSite.DFLASH_DRAFT_SAMPLE not in parse_spec_tp_sync("all,-17")
