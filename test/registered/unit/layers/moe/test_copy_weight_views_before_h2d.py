...
def test_deferred_loader_preserves_native_copy_views():
...
def test_deferred_loader_orders_overlapping_destinations():
    layer = _CopyOnlyMxfp4MoE()
...
def test_deferred_copy_workers_share_cpus_between_local_model_workers():
    parallel = mock.Mock(
    ...
    with (
        ...
        assert _deferred_weight_copy_workers() == 20
