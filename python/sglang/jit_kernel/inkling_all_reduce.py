...
_AR_TUNED_TP4 = {
    ...
    12: ("v5", 8, 512), 16: ("v5", 8, 512), 24: ("v5", 8, 1024), 32: ("v5", 8, 1024),
    48: ("v5", 48, 1024), 64: ("v5", 48, 1024), 96: ("v5", 64, 1024),
    128: ("mm", 0, 0), 192: ("mm", 0, 0),
    256: ("v3b", 64, 1024), 384: ("v3b", 32, 1024), 512: ("v3b", 32, 1024),
    768: ("v3b", 48, 512), 1024: ("v3b", 32, 1024),
    1536: ("v3", 64, 512), 2048: ("v3", 64, 512), 3072: ("v3", 96, 512),
...
_AR_TUNED_TP8 = {
    ...
    12: ("mm", 0, 0), 16: ("mm", 0, 0), 24: ("mm", 0, 0), 32: ("mm", 0, 0),
    48: ("mm", 0, 0), 64: ("mm", 0, 0), 96: ("mm", 0, 0), 128: ("mm", 0, 0),
    192: ("mm", 0, 0), 256: ("mm", 0, 0), 384: ("mm", 0, 0), 512: ("mm", 0, 0),
    768: ("mm", 0, 0), 1024: ("v3", 32, 512), 1536: ("v3", 16, 1024),
    2048: ("v3", 32, 512), 3072: ("v3", 48, 512), 4096: ("v3", 48, 512),
    6144: ("v3", 64, 512), 8192: ("v3", 96, 256), 12288: ("v3", 64, 512),
    16384: ("v3", 64, 512),
}
...
def inkling_two_shot_all_reduce_fused(
    ...
    module.two_shot_all_reduce_fused(
        buffer, data_ptrs_dev, flag_ptrs_dev, state_ptr, rank, num_items, num_blocks, block_size
    )
...
def inkling_multimem_one_shot_fused(
    ...
    module.multimem_one_shot_fused(
        buffer, multicast_ptr, flag_ptrs_dev, state_ptr, rank, num_items,
        num_blocks, block_size, int(per_block_barrier),
    )
...
def inkling_multimem_full_oneshot(
    ...
    module.multimem_full_oneshot(
        in_buffer, out_buffer, multicast_ptr, flag_ptrs_dev, state_ptr, rank, num_items, num_blocks, block_size
    )
...
def inkling_multimem_push_oneshot(
    ...
    module.multimem_push_oneshot(
        in_buffer, out_buffer, mc_stage_ptr, local_stage_ptr, flag_ptrs_dev,
        state_ptr, rank, num_items, num_blocks, block_size, int(per_block_barrier),
    )
