...
def build_dflash_disagg_draft_input(
    ...
    spec_info = DFlashDraftInputV2(
        ...
        # The draft KV transfer (not a local forward) is what gates this batch
        # being schedulable, so there is no in-flight event to synchronize on.
        verify_done=None,
    ...
    # asserts both sides do; populating the FutureMap also makes verified_id /
