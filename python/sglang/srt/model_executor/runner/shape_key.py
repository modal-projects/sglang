...
class ShapeKey:
    ...
    dsa_variant: DSA decode dual-graph variant ("dense" / "sparse"), a prefill
        token/context variant, or None. Composes with variant_label so LoRA
        and DSA variants can be captured independently.
    """
